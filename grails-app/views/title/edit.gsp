...
<html>
	...
	<body>
		<a href="#edit-title" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-title" class="content scaffold-edit" role="main">
