...
<html>
	...
	<body>
		...
		<div id="show-title" class="content scaffold-show" role="main">
			<h1><g:message code="default.show.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<ol class="property-list title">
			
			</ol>
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${titleInstance?.id}" />
					<g:link class="edit" action="edit" id="${titleInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
