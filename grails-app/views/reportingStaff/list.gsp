...
<html>
	...
	<body>
		<a href="#list-reportingStaff" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-reportingStaff" class="content scaffold-list" role="main">
