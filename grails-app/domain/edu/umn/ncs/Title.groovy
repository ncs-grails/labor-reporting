...
/** 
This class represents study staff job titles.
*/
class Title {
	...
	String name
	/** Indicates whether this specific job title is still being used. */
	Boolean obsolete = true
	/** Date this job title was added to database */
	Date dateCreated = new Date()
	/** User account of person that added this job title to the database */
	String userCreated
	/** Application, used by person, to add the job title to the database. */
	String appCreated = 'labor'

	/** Sets default string, for this domain, to Title "name." */	
